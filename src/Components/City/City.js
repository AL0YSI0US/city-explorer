  ...
  render() {
    ...
    return (
      <>
        ...
        <Image src={`https://maps.locationiq.com/v3/staticmap?key=${process.env.REACT_APP_LOCATIONIQ_KEY}&center=${this.props.cityData.lat},${this.props.cityData.lon}&zoom=12`} alt="city map" title="Return search map" fluid />
      </>
    );
  }
}
